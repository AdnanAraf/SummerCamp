      ...
      <div>
        <div className="h-[400px] w-[300px] bg-white mt-[50px] pt-[20px]">
          ...
          <div>
            ...
            <p className="text-[16px] font-titleFont text-center mt-[5px] text-[#13265c] font-semibold">
              Email:<span className="text-black font-normal">{email}</span>
            </p>
