...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="shadow-lg sticky top-0 z-[100] bg-slate-50 lg:block hidden">
        <div className="lg:block hidden">
          <div className="flex justify-between  ">
            ...
            ></img> */}
                <div className="tooltip mt-[10px] mr-[260px] ">
      ...
      {/* RESPONSIVE */}
      <div className="shadow-lg sticky h-[50px] top-0 z-[100] bg-slate-50 lg:hidden block">
        <div className="flex gap-[20px] mt-[20px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
